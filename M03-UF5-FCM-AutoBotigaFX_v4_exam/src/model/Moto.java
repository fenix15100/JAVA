...
public class Moto extends Vehicle {
	...
	public Moto(String matricula, String marca, String model, String versio, int emisionsCO2, long preu,LocalDate data_matriculacio, String categoria, int cilindrada) {
