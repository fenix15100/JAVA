...
public class Inici {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		try{
			...
			String urlBaseDades = "jdbc:postgresql://192.168.123.31/autobotiga";
			String usuari = "postgres";
			String contrasenya = "Destino204";
		...
		do{
			...
			case 2:
				...
				matricula=br.readLine();
				if(vehicles.eliminarFCM(matricula)){
			...
			case 5:
				...
				marca=br.readLine();
				vehicles.imprimirPerMarcaFMC(marca);
				break;
				
			case 6:
				vehicles.actualitzarPreuFinalFMC();
				break;
			}
		}while(option != 0);
	}
